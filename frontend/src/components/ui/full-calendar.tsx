...
//   const sameHourEvents = events.filter((event) => isSameHour(event.start, hour));

//   return (
//     // <div className="relative h-20 border-t last:border-b flex flex-col">
//     <div className="h-20 border-t last:border-b">

//       {sameHourEvents.map((event) => {
//         const durationInMinutes = differenceInMinutes(event.end, event.start);
//         const hoursDifference = durationInMinutes / 60;
//         const startPosition = event.start.getMinutes() / 60;

//         return (
//           <div
//             key={event.id}
//             className={cn('flex items-start', dayEventVariants({ variant: event.color }))}
//             style={{
//               height: `${hoursDifference * 100}%`,
//               top: `${startPosition * 100}%`, // Adjust to control vertical spacing
