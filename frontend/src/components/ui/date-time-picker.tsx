  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month_caption: 'flex justify-between items-center w-full',
        ...
        selected: 'bg-green-600 text-white rounded-full hover:bg-green-300',
        // 'bg-green text-white hover:bg-primaryhover:text-white focus:bg-primary focus:text-white rounded-full',
      ...
      modifiersClassNames={{
        selected: 'bg-green-600 text-white rounded-full hover:bg-green-300', // Make sure this matches the selected class to ensure consistency
      }}
